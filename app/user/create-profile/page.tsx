...
import ProfileForm from '@/components/page/user/profile-form';
  ...
  return (
    <div className="h-full flex flex-col sm:flex-row px-10 py-5 gap-x-4 lg:justify-center">
      ...
      <div className="mt-4 sm:mt-14">
        {user ? <ProfileForm className="grid grid-cols-1 md:grid-cols-2 gap-y-4 md:gap-x-20 justify-items-start *:min-w-[240px]" email={user.email ?? ''}/> : <p>How did you breakthrough middleware..</p>}
      </div>
      {searchParams.email && (
